      ...
      <div className='container mx-auto px-6'>
        <motion.div
          ...
          <div className='relative z-10 max-w-2xl mx-auto'>
            <div className='w-16 h-16 rounded-xl bg-white/10 flex items-center justify-center text-white mx-auto mb-10'>
              <Mail size={28} />
            </div>
            ...
            <p className='text-white/95 text-base mb-12 font-light leading-relaxed'>
            ...
            <div className='flex flex-col sm:flex-row gap-4 p-2 rounded-full bg-white/10 border border-white/10'>
              <input
                ...
                className='flex-1 px-8 py-4 rounded-full bg-transparent text-white placeholder:text-white/60 focus:outline-none font-light'
              />
            ...
            <p className='mt-8 text-white/60 text-[10px] font-medium uppercase tracking-[0.3em]'>
